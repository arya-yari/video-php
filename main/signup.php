			...
			<div class="card-body">
				<form>
					...
					<div class="input-group form-group">
						...
						<input required="required" type="password" class="form-control" placeholder="re-write password">
					</div>
					<div class="form-group">
						<input required="required" type="submit" value="Submit" class="btn float-right login_btn">
					</div>
				</form>
			</div>
